...
#include "../libjingle.new/libjingle/talk/session/phone/portablemediaengine.h"

#include "../libjingle.new/libjingle/talk/session/phone/mediachannel.h"
...
public:
    ...
    cricket::PacketQueue *incomingPackets;
...
JabbinTransmitter::JabbinTransmitter(RTPMemoryManager *mgr) : RTPTransmitter(mgr)
{
    d = new Private;
}
...
{
    JabbinTransmissionParams *jParams = (JabbinTransmissionParams*)transparams;
    d->incomingPackets = (cricket::PacketQueue *)(jParams->incomingPackets);
...
RTPRawPacket*  JabbinTransmitter::GetNextPacket()
{
    ...
    cricket::PacketQueue::Data *data = d->incomingPackets->pop();
