...
include(../../../conf.pri)
SUBDIRS += $$JINGLE_CPP/talk/xmpp
JINGLE_CPP = .
INCLUDEPATH += $$JINGLE_CPP ../../jrtplib/
DEFINES += POSIX DEBUG _DEBUG
...
google_voice {
	...
	SOURCES += \
			...
			$$JINGLE_CPP/talk/session/phone/portablemediaengine.cpp \
