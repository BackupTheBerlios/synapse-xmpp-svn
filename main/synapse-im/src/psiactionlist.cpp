...
{
	{
		...
		IconAction *showNoOfflineStatusMsg = new IconAction (tr("Show Offline Without Status Messages"), "psi/show_offline", tr("Show Offline Without Status Messages"), 0, viewGroups, 0, true);
		showSelf->setWhatsThis (tr("Toggles visibility of offline contacts without status messages"));
...
//		actBugReport->setWhatsThis (tr("Report a Bug"));
...

	{
		...
		actPsiMUC->setWhatsThis (tr("Join Psi Discussion Room (Online)"));
