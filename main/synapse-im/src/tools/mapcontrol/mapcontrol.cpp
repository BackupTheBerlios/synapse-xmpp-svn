...
// 	painter.setViewport(10000000000,0,size.width(),size.height());
	...
	*/
	...
	painter.drawLine(screen_middle.x()+1, screen_middle.y()-10,
						  screen_middle.x()+1, screen_middle.y()+10); // |
	painter.drawLine(screen_middle.x()-10, screen_middle.y(),
						  screen_middle.x()+10, screen_middle.y()); // -
	painter.drawLine(screen_middle.x()-10, screen_middle.y()+1,
						  screen_middle.x()+10, screen_middle.y()+1); // -
