...
void OptionsTabEvents::applyOptions()
{
	...
	PsiOptions::instance()->setOption("options.ui.notifications.passive-popups.type", d->cb_popupType->currentText());
	PsiOptions::instance()->setOption("options.ui.notifications.passive-popups.place", d->cb_popupPlacement->currentIndex());
	PsiOptions::instance()->setOption("options.ui.notifications.passive-popups.timeout", d->sb_popupTimeout->value() * 1000);
}
...
void OptionsTabEvents::restoreOptions()
{
	...
	typeList << "Basic" << "Full";
	QString typeName = PsiOptions::instance()->getOption("options.ui.notifications.passive-popups.type").toString();
	int n = 0;
	...
	d->cb_popupPlacement->setCurrentItem(PsiOptions::instance()->getOption("options.ui.notifications.passive-popups.place").toInt());
	d->sb_popupTimeout->setValue(PsiOptions::instance()->getOption("options.ui.notifications.passive-popups.timeout").toInt()/1000);
